...
import bugTrackingImg from "../assets/images/bug_tracking.jpg";
import namanImg from "../assets/images/Naman.png";
import amulyaImg from "../assets/images/Amulya.jpeg";
import soumyaImg from "../assets/images/Soumya.jpeg";
import smritiImg from "../assets/images/Smriti.jpeg";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-8">
                CtrlX_Error helps development teams track, prioritize, and fix
                software bugs faster than ever before. Simplify your debugging
                workflow and improve your software quality.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              CtrlX_Error provides all the tools you need to effectively manage
              bugs and improve your software quality.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card hover:shadow-lg transition p-6">
              ...
              <p className="text-gray-600">
                Easily create, assign, and track bugs with a customizable
                workflow that fits your team's process.
              </p>
            </div>
            ...
            <div className="card hover:shadow-lg transition p-6">
              ...
              <p className="text-gray-600">
                Prioritize and track security vulnerabilities with specialized
            ...
            <div className="card hover:shadow-lg transition p-6">
              ...
              <p className="text-gray-600">
                Collaborate effectively with comments, mentions, and real-time
                updates to fix bugs faster.
              </p>
            </div>
            ...
            <div className="card hover:shadow-lg transition p-6">
              ...
              <p className="text-gray-600">
                Track key metrics like resolution time, bug density, and team
                performance with visual dashboards.
              </p>
            </div>
            ...
            <div className="card hover:shadow-lg transition p-6">
              ...
              <p className="text-gray-600">
                Get AI-powered suggestions for bug priority, severity, and
                assignment based on historical data.
              </p>
            </div>
            ...
            <div className="card hover:shadow-lg transition p-6">
              ...
              <p className="text-gray-600">
                Create and share custom reports with stakeholders to keep
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="card border hover:shadow-lg transition">
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-6">
                  Perfect for small teams getting started with bug tracking.
                </p>
            ...
            <div className="card border-2 border-primary shadow-lg scale-105 relative">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-6">
                  Ideal for growing development teams with more complex needs.
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mb-4 max-w-3xl mx-auto">
              CtrlX_Error was founded in 2025 by a team of developers who were
              frustrated with existing bug tracking solutions. We set out to
              create a tool that would make bug tracking simple, intuitive, and
              effective.
            </p>
            <p className="text-gray-600 mb-4 max-w-3xl mx-auto">
              Our mission is to help development teams deliver higher quality
              software by providing them with the tools they need to track and
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Dedicated professionals passionate about helping teams build
              better software.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Former software engineer with 15+ years of experience at leading
                tech companies, passionate about building tools that improve
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Full-stack developer who previously led engineering teams at
                startups and enterprises, focused on creating scalable and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Product leader with extensive experience in developer tools and
                project management software, committed to user-centered design
                principles.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Quality assurance expert with a passion for creating efficient
                testing processes and ensuring software reliability across
                multiple platforms.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://github.com/Rishy-09/CtrlX_Error"
                  target="_blank"
                  className="text-gray-600 hover:text-primary"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/amulya-jain04/"
                  target="_blank"
                  className="text-gray-600 hover:text-primary"
                >
                ...
                <a
                  href="https://www.facebook.com/profile.php?id=61571028873441"
                  target="_blank"
                  className="text-gray-600 hover:text-primary"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose max-w-none">
              ...
              <p className="text-gray-600 mb-4">
                By accessing or using CtrlX_Error, you agree to be bound by
              ...
              <p className="text-gray-600 mb-4">
                Permission is granted to temporarily use CtrlX_Error for
                personal or business purposes, subject to these Terms of
                Service.
              </p>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-600 py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
            Ready to improve your bug tracking workflow?
          </h2>
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of developers who are already using CtrlX_Error to
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#terms" className="text-gray-400 hover:text-primary">
                    Terms of Service
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-sm text-gray-400 text-center">
            <p>
              &copy; {new Date().getFullYear()} CtrlX_Error. All rights
              reserved.
            </p>
          </div>
        </div>
